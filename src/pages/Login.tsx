...
export default function Login() {
  const { user, loading, farmReady, signIn } = useAuth();
    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center px-6 sm:px-12 lg:px-16 py-12">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm mb-8">Sign in to your LampFarms account</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Your password" required className="h-11 rounded-xl" />
            </div>
