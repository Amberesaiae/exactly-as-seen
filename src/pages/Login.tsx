...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Navigation handled by auth state change + farmReady
  };
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md animate-fade-in">
        <CardHeader className="text-center">
          ...
          <CardDescription>Sign in to your LampFarms account</CardDescription>
        </CardHeader>
        <CardContent>
          <Button variant="outline" onClick={handleGoogleSignIn} className="w-full gap-2 rounded-full font-medium mb-4">
