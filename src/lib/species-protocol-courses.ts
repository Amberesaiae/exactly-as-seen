...
const LAYER_COURSES: ProtocolCourse[] = [
  ...
  c('layer', {
    ...
    durationDays: 1,
    delivery_method: 'drinking_water',
    indication: 'Week 7 deworm (research D49)',
    priority: 'critical',
    doseHint: 'Per label (0-day withdrawal)',
  }),
  c('layer', {
    product_name: 'Multivitamins',
    task_type: 'supplement',
  ...
  c('layer', {
    ...
    durationDays: 1,
    delivery_method: 'drinking_water',
    indication: 'Week 13 deworm (research D91)',
    priority: 'critical',
    doseHint: 'Per label (0-day withdrawal)',
  }),
  c('layer', {
...
const DUCK_COURSES: ProtocolCourse[] = [
  ...
  c('duck', {
    ...
    durationDays: 21,
    delivery_method: 'drinking_water',
    indication: 'Niacin supplementation through production (leg health)',
    priority: 'high',
    doseHint: '100-150 mg per gallon',
  }),
  c('duck', {
    product_name: 'PLAIN WATER ONLY (Pre-sale)',
    task_type: 'checkpoint',
...
const TURKEY_COURSES: ProtocolCourse[] = [
  ...
  c('turkey', {
    ...
    durationDays: 3,
    delivery_method: 'drinking_water',
    indication: 'Week 5 blackhead block',
    priority: 'critical',
    withdrawal_meat_days: 5,
  }),
  c('turkey', {
  ...
  c('turkey', {
    ...
    durationDays: 3,
    delivery_method: 'drinking_water',
    indication: 'Week 7 blackhead block',
    priority: 'critical',
    withdrawal_meat_days: 5,
  }),
  c('turkey', {
    ...
    durationDays: 2,
    delivery_method: 'drinking_water',
    indication: 'Post-Fowl Pox support',
    priority: 'high',
  }),
  c('turkey', {
    product_name: 'Blackhead Preventive',
    ...
    durationDays: 3,
    delivery_method: 'drinking_water',
    indication: 'Week 9 blackhead block',
    priority: 'critical',
    withdrawal_meat_days: 5,
  }),
  c('turkey', {
  ...
  c('turkey', {
    ...
    durationDays: 3,
    delivery_method: 'drinking_water',
    indication: 'Week 11 blackhead block',
    priority: 'critical',
    withdrawal_meat_days: 5,
  }),
  c('turkey', {
  ...
  c('turkey', {
    ...
    durationDays: 3,
    delivery_method: 'drinking_water',
    indication: 'Week 13 blackhead block',
    priority: 'critical',
    withdrawal_meat_days: 5,
  }),
  c('turkey', {
